                ...
                <div class="col-md-7">
                  ...
                  <form action="" method="POST">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Name of Event" name="store_name" required>
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Location" name="store_address" required>
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Ticket $" required name="email">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="NA" name="phone_no">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="DATE" name="sms_no">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Info" required name="website">
                      </div>
					  
                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Buy Ticket" required name="buy_ticket">
                      </div>
					  
					  <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Date for ordering" name="date_for_ordering">
                      </div>
                      ...
                      <div class="input-group" style="width:100%;" >
                        <select class="form-control" style="width:100%;" name="featured">
                          ...
                          <option value="1">Show Event</option>
                          <option value="0">Do Not Show Event</option>
                        </select>
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Click on the map to obtain the latitude" name="lat" onkeypress='validateLatLng(event)' id="latitude" required>
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Click on the map to obtain the longitude" name="lon" onkeypress='validateLatLng(event)' id="longitude" required>
                      </div>
