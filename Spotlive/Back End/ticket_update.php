<?php 
  ...
  if( isset($_POST['submit']) ) {
  	...
  	$itm = new Ticket();
    $itm->ticket_url = htmlspecialchars(trim(strip_tags($_POST['ticket_url'])), ENT_QUOTES);
            
    $controller->updateTicket($itm);
    echo "<script type='text/javascript'>location.href='ticket.php';</script>";
  }
              ...
              <div class="row">
                ...
                <div class="col-md-7">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Buy Ticket URL" name="ticket_url" required value="<?php if($ticket != null) echo $ticket->ticket_url; ?>">
                      </div>
					  
					  <br /> 
                      <p>
                          <button type="submit" name="submit" class="btn btn-info" onClick="checkInput()" role="button">Save</button> 
                          <a class="btn btn-info" href="ticket.php" role="button">Cancel</a>
                      </p>
