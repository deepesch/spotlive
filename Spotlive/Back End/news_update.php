              ...
              <div class="row">
                ...
                <div class="col-md-7">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Event Name" name="news_title" required value="<?php echo $news->news_title; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Event URL" name="news_url" required value="<?php echo $news->news_url; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Event URL" name="photo_url" value="<?php echo $news->photo_url; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <textarea type="text" class="form-control" placeholder="Event Summary" rows="10" name="news_content" id="details"><?php echo $news->news_content; ?></textarea>
                      </div>
