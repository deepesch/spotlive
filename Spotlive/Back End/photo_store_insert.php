                ...
                <div class="col-md-6">
                  ...
                  <form action="" method="POST">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Image URL" name="photo_url" required>
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Thumbnail Image URL" name="thumb_url" required>
                      </div>
