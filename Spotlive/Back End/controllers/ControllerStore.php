...
class ControllerStore
{
    ...
    public function updateStore($itm) 
    {
        $stmt = $this->pdo->prepare('UPDATE tbl_storefinder_stores
                                        ...
                                        SET store_name = :store_name, 
											...
											date_for_ordering = :date_for_ordering, 
        ...
        $result = $stmt->execute(
                            array('store_name' => $itm->store_name,
                                    ...
                                    'email' => $itm->email,
                                    'website' => $itm->website,
									'buy_ticket' => $itm->buy_ticket,
									'date_for_ordering' => $itm->date_for_ordering,
    ...
    public function getStores() 
    {
        ...
        foreach ($stmt as $row) 
        {
			...
			$itm->buy_ticket = $row['buy_ticket'];
			$itm->date_for_ordering = $row['date_for_ordering'];
