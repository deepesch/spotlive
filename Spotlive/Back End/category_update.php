      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="categories.php">Category</a></li>
        ...
        <div class="panel-body">
              <div class="row">
                <div class="col-md-7">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="URL Icon" name="category_icon" value="<?php echo $category->category_icon; ?>">
                      </div>

                </div>
                <div class="col-md-5">

                  <h4>Instead of URL, Upload a File</h4>
                  

                    <div class="input-group">
                      <p>Icon File [300 x 300]</p>
